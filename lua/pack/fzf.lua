...
function M.config()
    ...
    G.map({
        { 'n', '<leader>fa', ':Ag<cr>', {silent = true, noremap = true}},
        { 'n', '<leader>ff', ':Files<cr>', {silent = true, noremap = true}},
        { 'n', '<m-l>', ':BLines<cr>', {silent = true, noremap = true}},
        { 'n', '<m-g>', ':GFiles?<cr>', {silent = true, noremap = true}},
